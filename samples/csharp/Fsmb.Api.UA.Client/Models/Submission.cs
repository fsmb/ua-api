...
namespace Fsmb.Api.Ua.Client.Models
{
    ...
    {        
        ...
        [Newtonsoft.Json.JsonProperty(PropertyName = "npdbReport", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public NpdbReport NpdbReport { get; set; }

        /// <summary>
        /// NPDB report status (`NotAvailable`, `Available`, `Pending`)
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "npdbReportStatus", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = false)]
