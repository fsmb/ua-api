...
namespace Fsmb.Apis.Ua.Clients.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the OtherTraining class.
        /// </summary>
        public OtherTraining() { }

        /// <summary>
        /// Initializes a new instance of the OtherTraining class.
        /// </summary>
        public OtherTraining(Program program, Specialty specialty, string programType, string trainingStatus, DateTime? beginDate = default(DateTime?), DateTime? endDate = default(DateTime?), int? percentageClinical = default(int?), int? percentageAdministrative = default(int?))
        {
            Program = program;
            Specialty = specialty;
